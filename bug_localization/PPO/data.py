...
class TransformSamplingSubTraj:
    ...
    def __call__(self, traj):
        ...
        #print(traj['actlogprob'].shape,traj['stateval'].shape,traj["actions2"].shape,traj["observations"].shape)
        #(30, 1) (30, 1, 1) (31,) (31, 31, 1025)
...
def collate_fn(batch):
  #print(len(batch))
  inp={'actions':[],'observations':[],'rewards':[],'returns-to-go':[],'picked':[], 'actlogprob': [], 'stateval': []}
