...
parser.add_argument("--savedir", default="/scratch/nstevia/torchbeast/palaas/torchbeast",
...
parser.add_argument("--disable_cuda", action="store_true",
                    help="Disable CUDA.")
parser.add_argument("--num_actions", default=18, type=int, metavar="A",
...
def train(flags):
    ...
    if os.path.exists(checkpointpath):
        print('trueeeueueeueue eeeuh oui')
