...
from torchbeast.uniform_instance_gen import override
from torchbeast.updateEntTimeLB import calEndTimeLB
from Params import configs
from torchbeast.permissibleLS import permissibleLeftShift
from torchbeast.updateAdjMat import getActionNbghs
...
class SJSSP(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        #print(self.posRewards,'self.posRewards')
        if reward == 0:
