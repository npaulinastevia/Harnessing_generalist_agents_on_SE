...
parser.add_argument("--savedir", default="/scratch/nstevia/torchbeastppol2d/logs/torchbeast",
...
parser.add_argument("--core", default=6400, type=int, metavar="B",
                    help=".")
parser.add_argument("--unroll_length", default=40, type=int, metavar="T",#80 #40
    ...
    try:
        ...
        while True:
            ...
            #while not env_output['done'][0][0]:
                ...
                timings.time("step")
                fi = open('/scratch/nstevia/torchbeastppol2d/20outputrewOPT.txt', 'a+')
...
def learn(
 ...
 #{key: tensor[:-1] for key, tensor in learner_outputs.items()}
            ...
            fi = open('/scratch/nstevia/torchbeastppol2d/10outputepisodes.txt', 'a+')
            fi.write(
...
def train(flags):  # pylint: disable=too-many-branches, too-many-statements
    ...
    for i, data in enumerate(dataset):
        ...
        while True:
            ...
            fi = open('/scratch/nstevia/torchbeastppol2d/9testresults'+str(configs.n_j)+str(configs.n_m)+'.txt', 'a+')
    ...
    fi = open('/scratch/nstevia/torchbeastppol2d/20evaltimeOPT.txt', 'a+')
