...
class PPO:
    ...
    def update(self, memories, n_tasks, g_pool):
        ...
        for i in range(len(memories)):
            ...
            print(fea_mb_t_all_env[0].shape, adj_mb_t_all_env[0].shape, candidate_mb_t_all_env[0].shape,
                  mask_mb_t_all_env[0].shape)
            assert False
...
def main():
    ...
    for i_update in range(configs.max_updates):
        ...
        for i, env in enumerate(envs):
            ...
            #print(adj.shape,fea.shape,candidate.shape,mask.shape) #(1000, 1000) (1000, 2) (50,) (50,)
        ...
        fi = open('traintime'+str(configs.n_j)+str(configs.n_m)+'.txt', 'a+')
        fi.write(str(t4 - t3) + ',' + str(t5 - t4) + os.linesep)
        fi.close()
...
if __name__ == '__main__':
    ...
    fi.write(str() + ',' + str() + ',' + str(total2 - total1) + os.linesep)
    fi.close()
    print(total2 - total1)