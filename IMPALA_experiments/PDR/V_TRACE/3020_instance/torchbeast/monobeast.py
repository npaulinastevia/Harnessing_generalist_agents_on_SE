...
parser.add_argument("--savedir", default="/scratch/nstevia/torchbeastimpalal2d_5060/logs/torchbeast",
...
parser.add_argument("--core", default=6400, type=int, metavar="B",
                    help=".")
parser.add_argument("--unroll_length", default=1, type=int, metavar="T",#80
...
def act(
    ...
    try:
        ...
        dataLoaded = np.load('/scratch/nstevia/torchbeastimpalal2d_5060/torchbeast/DataGen/generatedData' + str(configs.n_j) + '_' + str(configs.n_m) + '_Seed' + str(
        ...
        while True:
            ...
            #while not env_output['done'][0][0]:
                ...
                timings.time("step")
                fi = open('/scratch/nstevia/torchbeastimpalal2d_5060/18outputrewOPT.txt', 'a+')
...
def learn(
    ...
    with lock:
        ...
        fi = open('/scratch/nstevia/torchbeastimpalal2d_5060/18outputepisodesOPT.txt', 'a+')
        fi.write(
...
def train(flags):  # pylint: disable=too-many-branches, too-many-statements
    ...
    checkpoint_pretrain = torch.load('/scratch/nstevia/torchbeastimpalal2d_5060/palaas/torchbeast/torchbeast-20230515-132901/model.tar')
    ...
    checkpoint()
    fi = open('/scratch/nstevia/torchbeastimpalal2d_5060/18traintimeOPT.txt', 'a+')
