...
class SequenceTrainer:
    ...
    def train_iteration(
        ...
        self.losses, self.nlls, self.entropies = [], [], []
        logs = dict()
    ...
    def train_step_stochastic(self, loss_fn, trajs):
        ...
        for b in range(1):#for b in range(0,inputs_n['observations'].shape[0],32):
            inputs={}
            inputs_n={}
            ...
            done_mask = torch.BoolTensor(dones[b:b+32]).to(device=self.device)
